# ðŸ’» DOM Theme Switcher

<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,100:0f172a&height=160&section=header&text=DOM%20Theme%20Switcher&fontSize=42&fontColor=38bdf8&fontFamily=Outfit" width="100%" />
</div>
...
A JS DOM manipulation playground demonstrating dynamic theme changes and color generation on button click events.
...
`ash
    git clone https://github.com/Sayed-Herzallah/dom-theme-switcher.git
    cd dom-theme-switcher
